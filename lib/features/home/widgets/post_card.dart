      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: AppDimensions.borderRadiusCardLarge,
            border: Border.all(
              color: isDark ? AppColors.glassCardBorderDark : AppColors.glassCardBorderLight,
              width: 1.2,
            ),
            gradient: LinearGradient(
              ...
              colors: isDark
                  ? [AppColors.glassCardGradientStartDark, AppColors.glassCardGradientEndDark]
                  : [AppColors.glassCardGradientStartLight, AppColors.glassCardGradientEndLight],
            ),
          ),
          child: Stack(
            children: [
        ...
        Row(
          ...
          children: [
            ...
            if (widget.imageUrl != null) ...[
              ...
              ClipRRect(
                borderRadius: BorderRadius.circular(AppDimensions.radiusImage),
                child: SizedBox(
                  width: 108,
                  height: 108,
                  child: Container(
